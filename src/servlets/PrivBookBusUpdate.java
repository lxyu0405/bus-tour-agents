...
/**
 * Servlet implementation class PrivBookBusUpdate
 */
@WebServlet("/PrivBookBusUpdate")
public class PrivBookBusUpdate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrivBookBusUpdate() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("PrivBookBusUpdate: " + privTemp);
		new PrivBookBusAO().updatePrivBookBus(privTemp);
	}
