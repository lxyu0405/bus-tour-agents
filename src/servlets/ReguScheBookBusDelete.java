...
/**
 * Servlet implementation class ReguScheBookBusDelete
 */
@WebServlet("/ReguScheBookBusDelete")
public class ReguScheBookBusDelete extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReguScheBookBusDelete() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ReguScheBookBusModel reguTemp = new ReguScheBookBusModel(
				...
				no_of_participants);
		System.out.println("ReguScheBookBusDelete: " + reguTemp);
		
		new ReguScheBookBusAO().deleteReguScheBookBus(reguTemp);
	}
