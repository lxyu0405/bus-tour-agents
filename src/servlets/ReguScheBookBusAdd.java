...
/**
 * Servlet implementation class ReguScheBookBusAdd
 */
@WebServlet("/ReguScheBookBusAdd")
public class ReguScheBookBusAdd extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReguScheBookBusAdd() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ReguScheBookBusModel reguTemp = new ReguScheBookBusModel(
				...
				no_of_participants);
		System.out.println("ReguScheBookBusAdd: " + reguTemp);
		
		new ReguScheBookBusAO().insertReguScheBookBus(reguTemp);
	}
