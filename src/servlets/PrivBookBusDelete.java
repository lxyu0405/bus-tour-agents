...
/**
 * Servlet implementation class PrivBookBusDelete
 */
@WebServlet("/PrivBookBusDelete")
public class PrivBookBusDelete extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrivBookBusDelete() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("PrivBookBusDelete: " + privTemp);
		new PrivBookBusAO().deletePrivBookBus(privTemp);
	}
